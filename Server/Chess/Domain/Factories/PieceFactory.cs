...
namespace Domain.Factories
{
    public class PieceFactory : IPieceFactory
    {
        ...
        {
            var bishopMoves = new PieceMovePattern(true, true, 1, 1);
        ...
        {
            var verticalMoves = new PieceMovePattern(false, true, 1, 0);
            var horizontalMoves = new PieceMovePattern(false, true, 0, 1);
            var bishopMoves = new PieceMovePattern(false, true, 1, 1);
        ...
        {
            var knightMoves1 = new PieceMovePattern(true, true, 1, 2);
            var knightMoves2 = new PieceMovePattern(true, true, 2, 1);
        ...
        {
            var verticalMoves = new PieceMovePattern(false, false, 1, 0);
        ...
        {
            var verticalMoves = new PieceMovePattern(true, true, 1, 0);
            var horizontalMoves = new PieceMovePattern(true, true, 0, 1);
            var bishopMoves = new PieceMovePattern(true, true, 1, 1);
